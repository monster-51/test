...
# heRkKh4UC-xCjKz-l3OKEZCRT85qxpO9
# yAMu96g8htI5R4dDmLh6PfZmhyKRJd-Q
api_dev_key = 'heRkKh4UC-xCjKz-l3OKEZCRT85qxpO9'                  # Публикация
external_service_url = 'https://pastebin.com/api/api_post.php'

redis_client = redis.StrictRedis(host='localhost', port=6379, db=0)                      
clickhouse_client = get_client(host='localhost', port=8123, user='default', password='123', database='search_service')  
